...
export function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="relative inline-flex h-7 w-11 items-center rounded-full transition-colors duration-300 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-white border border-gray-200 dark:border-gray-800"
      style={{
